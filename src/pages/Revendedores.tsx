  ...
  const updatePermission = (path: string, value: boolean) => {
    setPermissions((prev) => {
      ...
      if (keys.length === 1) {
        ...
        const section = (
          newPermissions as unknown as Record<string, Record<string, unknown>>
        )[keys[0]];
        if (section) {
    ...
    try {
      ...
      if (isEditing) {
        ...
        const formattedPermissions =
          emailService.formatPermissions(permissions);
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        {emailResult && (
          ...
          >
            <CheckCircle
              className={`h-4 w-4 ${emailResult.success ? "text-green-600" : "text-red-600"}`}
            />
            <AlertDescription
              className={
            ...
            >
              ...
              <div className="flex gap-2 mt-3">
                ...
                {emailResult.success &&
                  emailResult.message.includes("clipboard") && (
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
                      onClick={() => {
                        ...
                        const subject = encodeURIComponent(
                          "🎉 Bem-vindo à Agência Check - Suas credenciais de acesso",
                        );
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-600">
              Configure quais módulos e ações este revendedor pode acessar no
              sistema
            </p>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    updatePermission("dashboard", checked as boolean)
                  }
                />
                <Label htmlFor="dashboard" className="font-medium">
                  📊 Dashboard
                </Label>
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("vendas.view", checked as boolean)
                      }
                    />
                    <Label htmlFor="vendas-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("vendas.create", checked as boolean)
                      }
                    />
                    <Label htmlFor="vendas-create" className="text-sm">
                      Criar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("vendas.edit", checked as boolean)
                      }
                    />
                    <Label htmlFor="vendas-edit" className="text-sm">
                      Editar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("vendas.delete", checked as boolean)
                      }
                    />
                    <Label htmlFor="vendas-delete" className="text-sm">
                      Excluir
                    </Label>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="revendedores-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="revendedores-create" className="text-sm">
                      Criar
                    </Label>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("estoque.view", checked as boolean)
                      }
                    />
                    <Label htmlFor="estoque-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("estoque.create", checked as boolean)
                      }
                    />
                    <Label htmlFor="estoque-create" className="text-sm">
                      Adicionar itens
                    </Label>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("pagamentos.view", checked as boolean)
                      }
                    />
                    <Label htmlFor="pagamentos-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="pagamentos-manage" className="text-sm">
                      Gerenciar
                    </Label>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("envios.view", checked as boolean)
                      }
                    />
                    <Label htmlFor="envios-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("envios.manage", checked as boolean)
                      }
                    />
                    <Label htmlFor="envios-manage" className="text-sm">
                      Gerenciar
                    </Label>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("relatorios.view", checked as boolean)
                      }
                    />
                    <Label htmlFor="relatorios-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="relatorios-export" className="text-sm">
                      Exportar
                    </Label>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="configuracoes-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="configuracoes-edit" className="text-sm">
                      Editar
                    </Label>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 ml-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("ia.view", checked as boolean)
                      }
                    />
                    <Label htmlFor="ia-view" className="text-sm">
                      Visualizar
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updatePermission("ia.configure", checked as boolean)
                      }
                    />
                    <Label htmlFor="ia-configure" className="text-sm">
                      Configurar
                    </Label>
                  </div>
                </div>
          ...
          <div className="flex gap-2 pt-4">
            <Button type="submit" className="flex-1 gap-2" disabled={isSending}>
              {isSending ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
                  {isEditing
                    ? "Atualizando..."
                    : "Cadastrando e enviando email..."}
                </>
              ) : (
                <>
                  {isEditing ? (
...
export function Revendedores() {
  ...
  const getPermissionCount = (permissions: UserPermissions) => {
    ...
    count += Object.values(permissions.revendedores || {}).filter(
      Boolean,
    ).length;
    ...
    count += Object.values(permissions.configuracoes || {}).filter(
      Boolean,
    ).length;
      ...
      >
        <div>
          ...
          <p className="text-slate-600 mt-1">
            Gerencie revendedores e configure permissões com envio automático de
      ...
      >
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(
                revendedores.reduce((sum: number, r) => sum + r.totalSales, 0),
              )}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(
                revendedores.reduce((sum: number, r) => sum + r.balance, 0),
              )}
            </div>
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Gerencie revendedores, configure permissões e envie credenciais
                      ...
                      <TableRow key={revendedor.id}>
                        ...
                        <TableCell>
                          <span className="font-medium">
                            {revendedor.comission}%
                          </span>
                        </TableCell>
                        <TableCell>
                          <span className="font-medium">
                            {formatCurrency(revendedor.totalSales)}
                          </span>
                        </TableCell>
                        <TableCell>
                          <span className="font-medium">
                            {formatCurrency(revendedor.balance)}
                          </span>
                        </TableCell>
                        <TableCell>
                          <Badge variant="outline">
                            {getPermissionCount(revendedor.permissions)}{" "}
                            permissões
                          </Badge>
                        </TableCell>
                        <TableCell>
                          <Badge
                            variant={
                              revendedor.isActive ? "default" : "secondary"
                            }
                          >
