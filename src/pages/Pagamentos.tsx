    ...
    <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    onValueChange={(value: PixProvider) =>
                      setValue("pixProvider", value)
                    }
                    defaultValue="inter"
                  >
                    <SelectTrigger>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">cobranças criadas</p>
          </CardContent>
        </Card>
                        ...
                        <div className="flex items-center space-x-2">
                          {payment.qrCode && (
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                copyToClipboard(payment.qrCode!, "Código PIX")
                              }
                            >
      ...
      {payments.length === 0 && (
        <Alert>
          ...
          <AlertDescription>
            💡 <strong>Dica:</strong> Configure suas credenciais PIX na página
            de <strong>Configurações</strong>
            antes de criar cobranças. Você pode usar o Banco Inter ou 4send como
            provedor.
          </AlertDescription>
        </Alert>
      )}
