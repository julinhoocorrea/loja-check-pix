...
import { DollarSign, Gem, TrendingUp, Users, Wallet } from "lucide-react";
import {
  CartesianGrid,
  Line,
  LineChart,
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-slate-600">
          Visão geral das métricas de hoje -{" "}
        ...
        <Card className="hover:shadow-lg transition-shadow duration-300 cursor-pointer">
          ...
          <CardContent>
            <p className="text-sm text-slate-600">
              Cadastre vendas de diamantes e calcule automaticamente lucros e
              comissões
            </p>
          </CardContent>
        </Card>
